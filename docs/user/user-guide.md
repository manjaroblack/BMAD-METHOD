...
The BMad Method installs a `.bmad-core` directory in your project root. This directory contains all the agent definitions, workflows, and resources needed for AI-assisted development:

- `.bmad-core/agents/` - Individual agent definitions
- `.bmad-core/agent-teams/` - Team configurations
- `.bmad-core/workflows/` - Project workflow templates
- `.bmad-core/tasks/` - Reusable task definitions
- `.bmad-core/data/` - Knowledge base and preferences
...
Each agent in `.bmad-core/agents/` is a specialized AI assistant with specific capabilities:
