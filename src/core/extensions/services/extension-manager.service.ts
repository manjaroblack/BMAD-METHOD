...
export class ExtensionManager implements IExtensionManager {
  ...
  private async discoverAndLoadExtensions(): Promise<void> {
    ...
    const extensionPaths = [
      '/Users/ds/dev/BMAD-METHOD/extensions/bmad-2d-phaser-game-dev',
      '/Users/ds/dev/BMAD-METHOD/extensions/bmad-2d-unity-game-dev',
      '/Users/ds/dev/BMAD-METHOD/extensions/bmad-infrastructure-devops'
    ];
