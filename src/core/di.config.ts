...
export function configureContainer(): void {
  ...
  // Register commands
  container.register(TYPES.ICommand, () => new FlattenerCommand(
    container.get(TYPES.IFileDiscoverer)
  ), 'singleton');
  container.register(TYPES.ICommand, () => new InstallerCommand(
    container.get(TYPES.IInstallerService)
  ), 'singleton');
  
  // Register CLI service
  container.register(TYPES.ICliService, () => createCliService(
