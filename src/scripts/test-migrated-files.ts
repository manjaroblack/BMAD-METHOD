...
import { blue, bold, green, join, red, Deno.stat, yellow } from "deps";
    ...
    return [
      {
        ...
        files: [
          ...
          "src/lib/yaml-utils.ts",
          "src/lib/node-version-manager.ts",
        ],
      },
      {
        ...
        files: [
          "src/cli/cli.ts",
          "src/build-tools/web-builder.ts",
          "src/upgrade/v3-to-v5-upgrader.ts",
      ...
      },
      {
        name: "Scripts",
        files: [
          "src/scripts/manage-dependencies.ts",
          "src/scripts/master-optimizer.ts",
          "src/scripts/optimize-build.ts",
          "src/scripts/semantic-release-sync-installer.ts",
          "src/scripts/validate-installation.ts",
          "src/scripts/yaml-format.ts",
        ],
      },
      {
        name: "Version Management",
        files: [
          "src/version-management/bump-all-versions.ts",
          "src/version-management/bump-expansion-version.ts",
          "src/version-management/sync-installer-version.ts",
          "src/version-management/update-expansion-version.ts",
          "src/version-management/version-bump.ts",
        ],
      },
      {
        name: "Installer System",
        files: [
          "src/installers/bin/bmad.ts",
          "src/installers/lib/installer.ts",
          "src/installers/lib/config-loader.ts",
          "src/installers/lib/file-manager.ts",
          "src/installers/lib/ide-base-setup.ts",
          "src/installers/lib/ide-setup.ts",
          "src/installers/lib/incremental-updater.ts",
          "src/installers/lib/installer-validator.ts",
          "src/installers/lib/memory-profiler.ts",
          "src/installers/lib/module-manager.ts",
          "src/installers/lib/resource-locator.ts",
        ],
      },
    ];
  }
